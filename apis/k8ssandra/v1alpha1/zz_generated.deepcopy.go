...
func (in *ClientEncryptionOptions) DeepCopyInto(out *ClientEncryptionOptions) {
	*out = *in
	...
	if in.EncryptionStores != nil {
		in, out := &in.EncryptionStores, &out.EncryptionStores
		*out = new(EncryptionStores)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EncryptionStores) DeepCopyInto(out *EncryptionStores) {
	*out = *in
	out.KeystoreConfigMapRef = in.KeystoreConfigMapRef
	out.KeystorePasswordSecretRef = in.KeystorePasswordSecretRef
	out.TruststoreConfigMapRef = in.TruststoreConfigMapRef
	out.TruststorePasswordSecretRef = in.TruststorePasswordSecretRef
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EncryptionStores.
func (in *EncryptionStores) DeepCopy() *EncryptionStores {
	if in == nil {
		return nil
	}
	out := new(EncryptionStores)

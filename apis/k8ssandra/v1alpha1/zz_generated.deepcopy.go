...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CassandraJsonMapper) DeepCopyInto(out *CassandraJsonMapper) {
	*out = *in
	in.CassandraYaml.DeepCopyInto(&out.CassandraYaml)
	if in.ClientEncryptionOptions != nil {
		in, out := &in.ClientEncryptionOptions, &out.ClientEncryptionOptions
		*out = new(ClientEncryptionOptionsYaml)
		(*in).DeepCopyInto(*out)
	}
	if in.ServerEncryptionOptions != nil {
		in, out := &in.ServerEncryptionOptions, &out.ServerEncryptionOptions
		*out = new(ServerEncryptionOptionsYaml)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraJsonMapper.
func (in *CassandraJsonMapper) DeepCopy() *CassandraJsonMapper {
	if in == nil {
		return nil
	}
	out := new(CassandraJsonMapper)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CassandraYaml) DeepCopyInto(out *CassandraYaml) {
	*out = *in
	in.CassandraYamlBase.DeepCopyInto(&out.CassandraYamlBase)
	if in.ClientEncryptionOptions != nil {
		in, out := &in.ClientEncryptionOptions, &out.ClientEncryptionOptions
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CassandraYamlBase) DeepCopyInto(out *CassandraYamlBase) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CassandraYamlBase.
func (in *CassandraYamlBase) DeepCopy() *CassandraYamlBase {
	if in == nil {
		return nil
	}
	out := new(CassandraYamlBase)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClientEncryptionOptionsYaml) DeepCopyInto(out *ClientEncryptionOptionsYaml) {
	*out = *in
	in.ClientEncryptionOptions.DeepCopyInto(&out.ClientEncryptionOptions)
	in.EncryptionStoreConfig.DeepCopyInto(&out.EncryptionStoreConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClientEncryptionOptionsYaml.
func (in *ClientEncryptionOptionsYaml) DeepCopy() *ClientEncryptionOptionsYaml {
	if in == nil {
		return nil
	}
	out := new(ClientEncryptionOptionsYaml)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EncryptionStoreConfig) DeepCopyInto(out *EncryptionStoreConfig) {
	*out = *in
	if in.Keystore != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EncryptionStoreConfig.
func (in *EncryptionStoreConfig) DeepCopy() *EncryptionStoreConfig {
	if in == nil {
		return nil
	}
	out := new(EncryptionStoreConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ServerEncryptionOptions) DeepCopyInto(out *ServerEncryptionOptions) {
	*out = *in
	...
	if in.RequireEndpointVerification != nil {
		in, out := &in.RequireEndpointVerification, &out.RequireEndpointVerification
		*out = new(bool)
		**out = **in
	}
	if in.EnableLegacySslStoragePort != nil {
		in, out := &in.EnableLegacySslStoragePort, &out.EnableLegacySslStoragePort
		*out = new(bool)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServerEncryptionOptionsYaml) DeepCopyInto(out *ServerEncryptionOptionsYaml) {
	*out = *in
	in.ServerEncryptionOptions.DeepCopyInto(&out.ServerEncryptionOptions)
	in.EncryptionStoreConfig.DeepCopyInto(&out.EncryptionStoreConfig)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServerEncryptionOptionsYaml.
func (in *ServerEncryptionOptionsYaml) DeepCopy() *ServerEncryptionOptionsYaml {
	if in == nil {
		return nil
	}
	out := new(ServerEncryptionOptionsYaml)
